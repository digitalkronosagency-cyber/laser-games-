export function getLocalBusinessSchema() {
  return {
    ...
    description: 'Centre de loisirs indoor à Tours proposant laser game, lancer de hache et blind test.',
    ...
    geo: { '@type': 'GeoCoordinates', latitude: 47.3548, longitude: 0.7312 },
    ...
    sameAs: ['https://www.facebook.com/lasergameevolution', 'https://www.instagram.com/lasergameevolution'],
    hasOfferCatalog: {
      '@type': 'OfferCatalog',
      name: 'Activités Laser Game Evolution Tours',
      itemListElement: [
        { '@type': 'Offer', name: 'Laser Game', description: 'Labyrinthe immersif multi-étages, 4-30 joueurs' },
        { '@type': 'Offer', name: 'Lancer de Hache', description: 'Axe throwing indoor sécurisé' },
        { '@type': 'Offer', name: 'BlindTest', description: 'BlindTest vocal, 6000 titres, salle privée' },
        { '@type': 'Offer', name: 'Pack Multi-Activités', description: 'Laser game + hache + blind test' },
        { '@type': 'Offer', name: 'Anniversaire', description: 'Offre anniversaire sur mesure' },
        { '@type': 'Offer', name: 'Team Building', description: "Activités entreprise sur mesure" },
      ],
    },
  }
}
